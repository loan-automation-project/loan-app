...
//     axios
//       .post("http://localhost:1092/application", formData)
//       .then((response) => {
...
const LoanApplicationForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const formDataToSend = {
      ...
      marital_status: formData.martial_status,  // Fix the key name
      contact_info: formData.contact_number,    // Fix the key name
      address: formData.address,
      annual_salary: formData.annual_salary,    // Include salary if needed
