...
import "./AboutUs.css";
import aboutus from "../../assets/pictures/aboutus.jpg"; // Imported image
import contact from "../../assets/pictures/contact.png"; // Imported image
      ...
      <main className="aboutus-content">
        ...
        <section className="aboutus-section">
          <div className="aboutus-image">
            <img
              src={aboutus} // Use the imported image variable
              alt="About Us"
            />
          </div>
        ...
        {/* Section 2: Contact details on the left, image on the right */}
        <section className="contact-section">
          ...
          <div className="contact-image">
            <img
              src={contact} // Use the imported image variable
              alt="Contact Us"
            />
          </div>
        </section>
